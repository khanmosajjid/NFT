...
import { D3element, gradientBg, gradientBgDark, heroImg } from '../../assets'
const Home = () => {
    return (
      <>
        {/* Hero  */}
        <section
          className="relative pb-10 pt-20 md:pt-30 lg:h-[99vh] "
          id="home"
        >
          <picture className="pointer-events-none absolute inset-x-0 top-0 -z-10 dark:hidden">
            <img src={gradientBg} alt="gradient" />
          </picture>
          <picture className="pointer-events-none absolute inset-x-0 top-0 -z-10 hidden dark:block">
            <img src={gradientBgDark} alt="gradient dark" />
          </picture>

          <div className="container h-full">
            <div className="grid h-full items-center  gap-4 md:grid-cols-12">
              <div className="col-span-6 flex h-full flex-col items-center justify-between py-10 md:items-start md:py-20 xl:col-span-4">
              ...
              {/* Hero image  */}
              <div className="col-span-6 xl:col-span-8 w-full">
                <div className="relative text-center flex justify-end md:pl md:text-right">
                  ...
                  <div className="img-box mb-0 relative">
