    ...
    <>
      ...
      <div className="container">
        <div className="grid grid-cols-6 gap-x-7 gap-y-14 pt-24 pb-12 md:grid-cols-12">
          <div className="col-span-full sm:col-span-4 md:col-span-4">
             {/* Logo  */}
            <Link to={"/"} className="mb-6 inline-block">
              <img src={Logo} className="max-h-7 dark:hidden" alt="MetaNFT | NFT Marketplace" />
              <img src={LogoWhite} className="hidden max-h-7 dark:block" alt="MetaNFT | NFT Marketplace" />
            </Link>
          ...
          <div className="col-span-full sm:col-span-4 md:col-span-4 md:col-start-7">
            <h3 className="mb-6 font-display text-sm text-jacarta-700 dark:text-white">Quick LInks</h3>
            <ul className="flex flex-col space-y-1 dark:text-jacarta-300">
              <li>
                <a href="#home" className="hover:text-accent dark:hover:text-white">Home</a>
              </li>
              <li>
                <a href="#tranding" className="hover:text-accent dark:hover:text-white">Tranding</a>
              </li>
              <li>
                <a href="#collection" className="hover:text-accent dark:hover:text-white">Collections</a>
              </li>
              <li>
                <a href="#" className="hover:text-accent dark:hover:text-white">Buy</a>
              </li>
            </ul>
          </div>
        ...
        <div className="flex flex-col items-center justify-between space-y-2 py-8 sm:flex-row sm:space-y-0">
          <span className="text-sm dark:text-jacarta-400"
            >   MetaNFT — Made by
             <a href="#" className="hover:text-accent">  MetaNFT</a></span
          >
