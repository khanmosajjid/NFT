...
import { Banner, gradientLightBg, userAvt } from '../../../assets'
            ...
            <main className="pt-[5.5rem] lg:pt-24">
                ...
                <section className="relative py-16 dark:bg-jacarta-800">
                    <picture className="pointer-events-none absolute inset-0 -z-10 dark:hidden">
                        <img src={gradientLightBg} alt="gradient" className="h-full w-full" />
                    </picture>
                            ...
                            <div className="mb-12 md:w-1/2 md:pr-8">
                                ...
                                <div className="mb-6">
                                    ...
                                    <Tippy content={tooltipContent} placement="top">
                                        ...
                                        >
                                            <span className="max-w-[20rem] overflow-hidden text-ellipsis"> {address}</span>
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 24 24"
                                                width="24"
