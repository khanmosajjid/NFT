      ...
      <>
        <header
          className={`js-page-header fixed  top-0 z-20 w-full backdrop-blur transition-colors
             ${isScrolled ? "js-page-header--is-sticky " : "bg-transparent"} ${
            isMenuOpen ? "height-100" : ""
          }`}
        >
            ...
            >
              ...
              <div className="t-0 fixed left-0 z-10 flex w-full items-center justify-between bg-white p-6 dark:bg-jacarta-800 lg:hidden">
                ...
                <Link to={"/"} className="shrink-0">
                  <img
                    src={Logo}
                    className="max-h-7 dark:hidden logo"
                    alt="MetaNFT | NFT Marketplace"
                  />
                  <img
                    src={LogoWhite}
                    className="hidden max-h-7 dark:block logo"
                    alt="MetaNFT | NFT Marketplace"
                  />
                </Link>
